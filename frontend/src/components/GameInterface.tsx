...
export default function GameInterface({ onProcessAudio, isProcessing }: GameInterfaceProps) {
  ...
  const handleInstrumentSelect = (instrument: Instrument) => {
    ...
    if (instrument === correctAnswer) {
      ...
      alert(`不正解... 正解は「${japaneseNames[correctAnswer as Instrument]}」でした`);
    }
  ...
  return (
    <div className="game-interface bg-white p-6 rounded-lg shadow-md">
      ...
      <div className="mb-4">
        <div className="text-lg font-medium">スコア: <span className="text-blue-600">{score}</span></div>
      </div>
