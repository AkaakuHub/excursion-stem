	...
	return (
		<div className="max-w-4xl mx-auto">
			...
			<div className="bg-white rounded-xl shadow-md p-8 mb-8">
				...
				<ol className="list-decimal pl-6 space-y-4">
					<li className="text-lg">
						お好きな音楽ファイルをアップロードします（MP3, WAV, OGG,
						FLACがサポートされています）
					</li>
					<li className="text-lg">
			...
			<div className="text-center">
				<Link
					to="/game"
					className="inline-block bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-10 rounded-lg text-xl font-medium shadow-lg transition-colors"
				>
					ゲームを始める
				</Link>
			</div>
			...
			<div className="mt-16 text-center text-gray-500 text-sm">
				...
				<p className="mt-1">
					このアプリはFacebook Research Demucsを使用して音楽を分離しています
				</p>
			</div>
		</div>
	);
