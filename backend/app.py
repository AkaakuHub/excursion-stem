...
def process_audio():
    ...
    try:
        ...
        # 音声処理サービスを使用して分離
        separated_tracks = audio_service.process_audio_file(
        ...
        return jsonify({"status": "success", "tracks": track_urls}), 200
...
def preview_audio():
    ...
    try:
        ...
        if preview_path:
            ...
            return jsonify({"status": "success", "previewUrl": preview_url}), 200
        else:
